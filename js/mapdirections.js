...
function getDirectionsORS() {
  ...
  request.setRequestHeader('Authorization', '5b3ce3597851110001cf62487a9231f0aafb4d82afe9dd031a26d5d5');
  ...
  request.onreadystatechange = function () {
    if (this.readyState === 4) {
      ...
      L.geoJSON(responsejson).addTo(map);
      //return responsejson;
      // var node = document.getElementById("driving-car-directions");
      // node.innerHTML = "<h3>Response</h3><p>" + this.responseText + "</p>";
    }
  };

  const body = '{"coordinates":[[-46.63383007049561,-23.549274336622684],[-46.64096949118043,-23.544691004890126]],"options":{"avoid_polygons":{"type":"MultiPolygon","coordinates":[[[[-46.640739,-23.553956],[-46.640739,-23.548999],[-46.638508,-23.548999],[-46.638508,-23.553956],[-46.640739,-23.553956]]],[[[-46.636448,-23.543452],[-46.639023,-23.54713],[-46.632972,-23.544239],[-46.636448,-23.543452]]]]}}}';

  request.send(body);
}
//getDirectionsORS();

function getDirectionsORS2() {
  ...
  orsDirections.calculate({
    coordinates: [[-46.63383007049561,-23.549274336622684],[-46.64096949118043,-23.544691004890126]],
    profile: "driving-car",
    ...
    options:{
      avoid_polygons:{
        type: "MultiPolygon",
        coordinates:[[[[-46.640739,-23.553956],[-46.640739,-23.548999],[-46.638508,-23.548999],[-46.638508,-23.553956],[-46.640739,-23.553956]]],[[[-46.636448,-23.543452],[-46.639023,-23.54713],[-46.632972,-23.544239],[-46.636448,-23.543452]]]]
      }
    }
  })
    .then(function(json) {
